...
- having a central place (cannonical name) to refer to infra resources is still very 
  much beneficial
  - centralized names does not alays mean, single point of failure
  - 
...
11. an infrastructure engineer/architect abhors doing the same thing twice, this makes 
    different from systems administrators, who in many cases don't mind the
    repetition 
12. gold server is passive, clients pull, and they are always responsible for keeping 
    themselves up to date
13. the gold server was not mission-critical, it could go down without impacting the 
    infrastructure
14. immutable infrastructure: never login to a machine to make a change that can be 
    made in the golden server and then propagated to all the other machines
15. no matter how small the infrastructure, making ad-hoc changes by pushing them to 
...
24. they only reason there's an infrastructure is to run applications that are 
...
37. Recruiters generally don’t even know what an ‘‘infrastructure architect’’ is, and far too often assume that ‘‘senior sysadmin’’ means you know how to flip tapes faster.
...
39. Some of the most capable systems administrators we’ve known are not interested in coding
    1. different mindsets/interests: those who want hands on work and don’t mind repetition, and those who hate repetition
40. infrastructure architects tend to spend most of their time writing code. They are motivated by challenges and impatience – they hate doing the same thing twice
...
1. Boot sequence: [link](../assets/diagram/boot-sequence.puml), dependency between tasks when 
   bootstrapping an infra
2. Principles for building infrastructures: [link](../assets/diagram/building-infrastructure.puml)
